  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      ...
      try {
        ...
        // Para gráficos temporais, usar dados de 12 meses completos, ignorando o filtro de data
      ...
      try {
        ...
        // Para o gráfico de tendência mensal, usar dados de 12 meses completos, ignorando o filtro de data
        const getFullYearExpensesForChart2 = (allExpenses: any[], childrenFilter: string[]) => {
          if (!allExpenses) return [];
        ...
        const fullYearExpensesForTrend = getFullYearExpensesForChart2(expenses, selectedChildren);
        const trendChartImage = await generateTrendChart(fullYearExpensesForTrend);
