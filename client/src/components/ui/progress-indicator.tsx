...
export function ProgressIndicator({ 
  ...
  return (
    <div className={`bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden border border-gray-200 dark:border-gray-700 ${className}`} data-testid="progress-indicator">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="text-center">
          <p className="text-base font-medium text-gray-800 dark:text-gray-200" data-testid="progress-message">
            {message}
          </p>
        </div>
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 px-4 py-2">
